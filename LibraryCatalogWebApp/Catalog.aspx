...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <div>
    <div>
        ...
        <asp:Button runat="server" ID="button1" Text="Search Title" Width ="110px" OnClick="getBooksByAuthor"/>
    </div>
        <asp:TextBox runat="server" ID="SearchBook"></asp:TextBox>
        <asp:Button runat="server" ID="button2" Text="Search Author" Width="110px" OnClick="getBooksByTitle"/>
   </div>
